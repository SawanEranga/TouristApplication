...
Find Things to Do, Attractions, Places to Visit & <span class="color" >More </span>
		...
		<section id="works" class="works clearfix">
			...
			<div class="project-wrapper">
				...
				<figure class="mix work-item branding P_cat_img_figure makemousepointer">
...
Beaches
					...
					<figcaption id="cat_Beachs" class="overlay makemousepointer P_routeToCat">
...
Wild
				...
				<figure class="mix work-item branding P_cat_img_figure">
					<img class="P_cat_img" src="<?php echo base_url() ?>assets/main/imgs/cat/bliss.jpg" alt="">
          <div class="P_text_on_image">
            <div class="P_text_on_img_inner">
Bliss
            </div>
				...
				<figure class="mix work-item web P_cat_img_figure">
					<img class="P_cat_img" src="<?php echo base_url() ?>assets/main/imgs/cat/scenic.png" alt="">
          <div class="P_text_on_image">
            <div class="P_text_on_img_inner">
Scenic
            </div>
				...
				<figure class="mix work-item logo-design P_cat_img_figure">
					<img class="P_cat_img"src="<?php echo base_url() ?>assets/main/imgs/cat/essence.jpg" alt="">
          <div class="P_text_on_image">
            <div class="P_text_on_img_inner">
Essence
            </div>
				...
				<figure class="mix work-item photography P_cat_img_figure">
					<img class="P_cat_img" src="<?php echo base_url() ?>assets/main/imgs/cat/festival.jpg" alt="">
          <div class="P_text_on_image">
            <div class="P_text_on_img_inner">
Festive
            </div>
		...
		<section id="facts" class="facts">
          ...
          <div class="row number-counters">
					...
					</div>	<div class="row number-counters">
