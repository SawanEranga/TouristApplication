...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/ishan/css/style.css" />
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3 form-box">
                        ...
                        <div class="form-bottom">
                            <form role="form" action="<?php echo site_url() ?>/User/register" method="post" class="login-form">
                                <div class="form-group">
                                    <label class="sr-only" for="form-username">First Name</label>
                                    <span class="error_messages"><?php echo $vv["fname"] ?></span>
                                    <input type="text" name="form-fname" placeholder="First Name..." class="form-username form-control" id="form-fname">
                                </div>
                                <div class="form-group">
                                    <span class="error_messages"><?php echo $vv["lname"] ?></span>
                                    <label class="sr-only" for="form-username">Last Name</label>
                                    <input type="text" name="form-lname" placeholder="Last Name..." class="form-username form-control" id="form-lname">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="sr-only" for="form-username">Telephone Number</label>
                                    <input type="text" name="form-tel" placeholder="Telephone Number..." class="form-username form-control" id="form-tel">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="form-con-password" placeholder="Confirm Password..." class="form-password form-control" id="form-con-password">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-country">Country</label>
                                    <select style="height:50px" class="form-password form-control" name="form-country" id="form-country">
                                        ...
                                        <option value="144" selected="selected">Sri Lanka</option>
